...
import { dirname, normalize, isAbsolute, resolve as resolve$1, join, relative, basename } from 'pathe';
...
async function bundle(nuxt) {
  const viteConfigPrefix = resolve$1(nuxt.options.rootDir, "vite.config");
